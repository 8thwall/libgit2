...
#define TEST_REPO_PATH "sparsemin"

void test_sparse_status__reapply(void)
{
	status_entry_single st;
	git_sparse_checkout_init_options scopts = GIT_SPARSE_CHECKOUT_INIT_OPTIONS_INIT;
	g_repo = cl_git_sandbox_init("sparsemin");

	cl_assert(git_fs_path_exists(TEST_REPO_PATH "/folder/in-folder.txt"));
	cl_assert(git_fs_path_exists(TEST_REPO_PATH "/top-level.txt"));
...
void test_sparse_status__cleanbase(void)
{
	status_entry_single st;
	git_sparse_checkout_init_options scopts = GIT_SPARSE_CHECKOUT_INIT_OPTIONS_INIT;
	g_repo = cl_git_sandbox_init("sparsemin");
